...
func neiro(paths string) {
	...
	url := "https://www.visionhub.ru/api/v2/auth/generate_token/"
	method := "GET"
	...
	req.Header.Add("Cookie", "csrftoken=O49awjFV9pjEwd7RdQCcyqurc5NED0EP5lVuuaEnfALQz6CRtRGtOmBOD0Xipw4b")
	...
	url = "https://www.visionhub.ru/api/v2/process/img2img/"
	method = "POST"

	payload = &bytes.Buffer{}
	writer = multipart.NewWriter(payload)
	_ = writer.WriteField("model", "people_segmentator")
	_ = writer.WriteField("image", open(paths, "rb"))
	err = writer.Close()
	if err != nil {
		fmt.Println(err)
	}
	...
	url = "https://www.visionhub.ru/api/v2/task_result/"
	method = "GET"
	...
	url = "https://www.visionhub.ru" + m.Url
	method = "GET"
